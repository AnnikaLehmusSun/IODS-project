...
####The data "human" is a dataset that contains two data:"human development" and "gender inequality" datas. More information about the data you can find from: http://hdr.undp.org/en/content/human-development-index-hdi. Below you can find the structure and dimesions of the data. 
