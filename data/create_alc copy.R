...
student_mat <- read.csv("/Applications/IODS-project/data/student-mat.csv", sep = ";" , header = TRUE)
student_por <- read.csv("/Applications/IODS-project/data/student-por.csv", sep = ";" , header = TRUE)
str(student_mat)
str(student_por)
dim(student_mat)
dim(student_por)
...
write.csv(math_por, file = "/Applications/IODS-project/data/math_por.csv")
write.csv(alc, file = "/Applications/IODS-project/data/alc.csv")
